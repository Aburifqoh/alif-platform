      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
          {[
            ...
            { label: "Approved",     value: approved,            color: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30" },
                    ...
                    return (
                      <tr key={app.id} className="border-b border-gray-50 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/3 transition-colors">
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#0f5132] to-[#166534] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
  ...
  return (
    <>
      ...
      <Link
        ...
        className="px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 text-xs font-semibold hover:bg-emerald-100 transition-colors"
      >
        Manage
      </Link>
    </>
