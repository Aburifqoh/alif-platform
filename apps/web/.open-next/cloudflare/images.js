...
var define_IMAGES_REMOTE_PATTERNS_default = [{ hostname: "^(?:(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\.supabase\\.co\\/?)$", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }, { hostname: "^(?:^(?:lh3\\.googleusercontent\\.com)$)$", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }];
...
// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.20.2_next@16.2.12_react-dom@19.2.4_react@19.2.4__react@19.2.4__wrangler@4.120.0/node_modules/@opennextjs/cloudflare/dist/cli/templates/images.js
