...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-gradient-to-br from-brand-charcoal via-[#24465B] to-brand-blue-dark">
      ...
      {/* Glowing orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-brand-gold/15 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-brand-red/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="py-4 px-6 bg-white/8 border border-white/15 rounded-2xl backdrop-blur-sm">
            <p className="text-2xl text-brand-gold font-[Amiri] text-right leading-loose arabic" dir="rtl">
          ...
          <div className="flex flex-wrap gap-8 pt-4">
            {[
              ...
              <div key={s.label}>
                <div className="text-2xl font-bold text-brand-gold font-[Outfit]">{s.value}</div>
        ...
        <div className="hidden lg:block">
          <div className="relative bg-white/10 border border-white/20 rounded-3xl p-8 backdrop-blur-xl">
            ...
            {prayerTime && (
              <div className="mb-6 p-4 bg-[#b8860b]/20 border border-[#b8860b]/30 rounded-2xl flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-brand-gold font-bold text-2xl font-[Outfit]">{prayerTime.time}</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: BookOpen, label: "Courses", href: "/programs/education", color: "from-brand-red to-brand-red-dark" },
    ...
    <section id="mission" className="py-24 bg-white dark:bg-[#0d1117]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">Our Purpose</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="group p-8 rounded-3xl border border-gray-100 dark:border-white/10 bg-gradient-to-br from-[#f0fdf4] to-white dark:from-emerald-950/30 dark:to-[#161b22] hover:shadow-xl transition-all">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-brand-red to-brand-red-dark flex items-center justify-center mb-6">
  ...
  return (
    <section className="py-24 bg-[#faf6ef] dark:bg-[#161b22]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">About ALIF</span>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/about"
              className="inline-flex items-center gap-2 px-6 py-3 bg-brand-red text-white font-semibold rounded-full hover:bg-[#166534] transition-colors font-[Outfit]"
            >
          ...
          {[
            ...
            <div key={item.label} className="p-5 bg-white dark:bg-[#21262d] rounded-2xl border border-gray-100 dark:border-white/8 hover:shadow-md transition-all group">
              <div className={`w-10 h-10 rounded-xl mb-3 flex items-center justify-center ${
                item.color === "emerald" ? "bg-brand-red-tint dark:bg-brand-red-dark/50 text-brand-red dark:text-brand-red-light" :
    ...
    <section className="py-24 bg-white dark:bg-[#0d1117]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-12 gap-4">
          <div>
            <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">What's Coming</span>
            <h2 className="mt-2 text-4xl font-bold text-gray-900 dark:text-white font-[Outfit]">Upcoming Events</h2>
          </div>
          <Link
            href="/events"
            className="inline-flex items-center gap-2 text-brand-red dark:text-brand-red-light font-semibold hover:gap-3 transition-all text-sm"
          >
          ...
          {events.map((event) => (
            <div key={event.title} className="group p-5 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#161b22] hover:shadow-lg transition-all hover:-translate-y-1">
              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold mb-4 ${
                event.color === "emerald" ? "bg-brand-red-tint dark:bg-brand-red-dark/50 text-brand-red dark:text-brand-red-light" :
              ...
              <Link
                href="/events"
                className="mt-4 block text-center px-4 py-2 bg-gray-50 dark:bg-white/5 hover:bg-[#f0fdf4] dark:hover:bg-brand-red-dark/30 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:text-brand-red dark:hover:text-brand-red-light rounded-lg transition-all"
              >
                Register →
              </Link>
            </div>
...
function ProgramsSection() {
  const programs = [
    { icon: BookOpen, title: "Islamic Education", desc: "Aqeedah · Fiqh · Hadith · Tafseer · Seerah", href: "/programs/education", color: "from-brand-red to-brand-red-dark" },
  ...
  return (
    <section className="py-24 bg-[#faf6ef] dark:bg-[#161b22]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">What We Offer</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {programs.map((prog) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-1 text-brand-red dark:text-brand-red-light text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
...
function StatsSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-brand-charcoal via-[#24465B] to-brand-blue-dark relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-brand-gold text-sm font-semibold uppercase tracking-widest">By The Numbers</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center p-6 bg-white/8 border border-white/15 rounded-2xl backdrop-blur-sm hover:bg-white/12 transition-all">
              <stat.icon className="w-7 h-7 text-brand-gold mx-auto mb-3" />
  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0d1117]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-12 gap-4">
          <div>
            <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">Knowledge</span>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {articles.map((art) => (
            <article key={art.title} className="group p-6 rounded-2xl border border-gray-100 dark:border-white/10 bg-white dark:bg-[#161b22] hover:shadow-xl hover:-translate-y-1 transition-all">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-[#f0fdf4] dark:bg-brand-red-dark/50 text-brand-red dark:text-brand-red-light mb-4">
                {art.category}
              </span>
              <h3 className="text-lg font-bold text-gray-900 dark:text-white font-[Outfit] mb-3 leading-snug group-hover:text-brand-red dark:group-hover:text-brand-red-light transition-colors">
                {art.title}
              </h3>
...
function Testimonials() {
  ...
  return (
    <section className="py-24 bg-[#faf6ef] dark:bg-[#161b22]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-brand-red dark:text-brand-red-light text-sm font-semibold uppercase tracking-widest">Voices</span>
          <h2 className="mt-3 text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white font-[Outfit]">
            ...
            <div key={t.name} className="p-7 bg-white dark:bg-[#21262d] rounded-2xl border border-gray-100 dark:border-white/8 hover:shadow-xl transition-all">
              <div className="flex gap-0.5 mb-5">
                {Array.from({ length: t.rating }).map((_, i) => (
                  <Star key={i} className="w-4 h-4 fill-[#d4a017] text-brand-gold" />
                ))}
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-red to-brand-red-dark flex items-center justify-center text-white text-sm font-bold">
  ...
  return (
    <section className="py-24 bg-white dark:bg-[#0d1117]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <div className="p-10 rounded-3xl bg-gradient-to-br from-brand-charcoal via-[#24465B] to-brand-blue-dark relative overflow-hidden">
          ...
          <div className="relative">
            <span className="text-brand-gold text-sm font-semibold uppercase tracking-widest">Stay Connected</span>
            ...
            {submitted ? (
              <div className="mt-6 p-4 bg-[#d4a017]/20 border border-[#d4a017]/30 rounded-xl text-brand-gold font-medium">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            { icon: BookOpen, title: "Sponsor a Student", desc: "Fund a student's Islamic education journey", color: "from-brand-red to-brand-red-dark", href: "/donate/sponsor" },
            ...
            >
              ...
              <div>
                <h3 className="text-base font-bold text-gray-900 dark:text-white font-[Outfit] mb-1 group-hover:text-brand-red dark:group-hover:text-brand-red-light transition-colors">
                  {item.title}
                </h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">{item.desc}</p>
                <span className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-brand-red dark:text-brand-red-light">
...
export default function HomePage() {
  useEffect(() => {
    const seedProgrammes = async () => {
      try {
        const { createClient } = await import("@alif/database/client");
        ...
        // Seed if none exist or upsert onConflict
        await supabase
          .from("alif_programmes")
          .upsert(programs, { onConflict: "slug" });
      } catch (err) {
        console.error("Failed to seed programmes on load:", err);
      }
    };
    seedProgrammes();
  }, []);
