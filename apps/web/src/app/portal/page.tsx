...
export default async function PortalDashboard() {
  ...
  const quickLinks = [
    { icon: BookOpen,   label: "My Courses",     href: "/portal/courses",       color: "from-brand-red to-brand-red-dark" },
    ...
    <div className="min-h-screen bg-[#faf6ef] dark:bg-[#0d1117]">
      ...
      <header className="bg-white dark:bg-[#161b22] border-b border-gray-100 dark:border-white/8 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-brand-red dark:text-brand-red-light font-[Outfit] hidden sm:block">ALIF Portal</span>
          </Link>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-white/5 text-sm text-gray-700 dark:text-gray-300">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-brand-red to-brand-red-dark flex items-center justify-center text-white text-xs font-bold">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {[
            { label: "Courses Enrolled", value: "—", icon: BookOpen, color: "text-brand-red dark:text-brand-red-light bg-brand-red-subtle dark:bg-brand-red-dark/30" },
        ...
        <div className="bg-white dark:bg-[#161b22] rounded-2xl border border-gray-100 dark:border-white/8 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/events" className="text-sm text-brand-red dark:text-brand-red-light font-medium flex items-center gap-1">
          ...
          <div className="text-center py-8 text-gray-400 dark:text-gray-500">
            ...
            <Link href="/events" className="mt-3 inline-block text-sm text-brand-red dark:text-brand-red-light hover:underline">
              Browse events →
            </Link>
          </div>
        </div>
