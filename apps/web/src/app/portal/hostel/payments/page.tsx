...
export default function PaymentsPage() {
  ...
  const statusConfig: Record<string, { label: string; color: string; icon: React.ElementType }> = {
    ...
    paid:    { label: "Paid",    color: "text-brand-red bg-brand-red-subtle dark:text-brand-red-light dark:bg-brand-red-dark/30", icon: CheckCircle2 },
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-brand-red to-brand-red-dark rounded-2xl p-5">
      ...
      {successMsg && (
        <div className="flex items-center gap-3 p-4 rounded-xl bg-brand-red-subtle dark:bg-brand-red-dark/20 border border-brand-red-tint dark:border-brand-red-dark">
          ...
          <p className="text-sm text-brand-red-dark dark:text-brand-red-light">{successMsg}</p>
        </div>
      )}
      {error && (
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  {fee.status === "paid" ? (
                    ...
                    <button
                      ...
                      disabled={!!paying}
                      className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-brand-red to-brand-red-dark text-white text-xs font-bold hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0 transition-all font-[Outfit]"
                    >
