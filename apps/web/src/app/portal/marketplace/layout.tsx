...
import {
  Store, UserCircle, PlusCircle, ArrowLeft, Settings
} from "lucide-react";

const navItems = [
  { icon: Store,          label: "Browse Items",   href: "/portal/marketplace" },
  { icon: UserCircle,     label: "Seller Profile", href: "/portal/marketplace/seller-profile" },
  { icon: PlusCircle,     label: "Sell an Item",   href: "/portal/marketplace/new" },
];
      ...
      <aside className="w-full lg:w-64 lg:min-h-screen bg-white dark:bg-[#161b22] border-b lg:border-b-0 lg:border-r border-gray-100 dark:border-white/8 flex-shrink-0">
        <div className="p-4 lg:p-6">
          ...
          <div className="flex items-center gap-3 mb-6 lg:mb-8">
            ...
            <div>
              <div className="font-bold text-gray-900 dark:text-white text-sm font-[Outfit]">ALIF Commerce</div>
              <div className="text-xs text-gray-400">Community Marketplace</div>
            </div>
          </div>
