    ...
    <div className="min-h-screen bg-[#faf6ef] dark:bg-[#0d1117] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-xs text-brand-red dark:text-brand-red-light hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-gray-900 dark:text-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0f5132]/20 focus:border-brand-red dark:focus:border-brand-red transition-all"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-brand-red to-brand-red-dark text-white font-semibold rounded-xl hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-60 disabled:hover:translate-y-0 transition-all font-[Outfit]"
            >
              {loading ? (
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link href="/register" className="text-brand-red dark:text-brand-red-light font-semibold hover:underline">
            Create one
          </Link>
        </p>
      </div>
